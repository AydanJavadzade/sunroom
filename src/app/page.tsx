  ...
  return (
    <>
      <main className="flex flex-col min-h-screen">
        ...
        {/* 2nd Section with Overlap */}
        <div className="relative w-full h-[700px] p-14 rounded-t-3xl bg-slate-200 flex flex-col gap-4 -mt-20">
          <div className="flex flex-col gap-3 h-1/2 md:h-1/4">
            ...
            <p className="text-xl font-sans tracking-tight text-left shadow-sm mb-2">
