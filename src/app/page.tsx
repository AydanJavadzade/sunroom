  ...
  return (
    <>
      ...
      <main className=" ">
        ...
        <header className='relative w-full min-h-[700px] bg-[url(/fon.png)] bg-cover bg--no repeat' >
          <MainNavbar />
        ...
        {/* 2ci hisse */}
        <div className=" absolute left-0 top-[600px] w-full h-[650px] p-10 rounded-t-3xl bg-slate-200 flex flex-col gap-16">
